...
interface DashBoardActivityItemProps extends CardItem {
};

const DashBoardActivityItem = (props: DashBoardActivityItemProps) => {
    if (props.clickable == true) {
        return (
            ...
            <div className="ml-auto">
                    <span className="flex text-(--color-primary) text-sm border p-1 rounded-3xl w-full min-w-15 justify-center bg-(--color-hover-light)">{props.type}</span>
            </div>
        </div>
        );
    }
